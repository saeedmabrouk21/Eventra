...
* **Tenant Admin** – manages users within a tenant
* **System** – background processing & integrations
* **Platform Admin (optional)** – global oversight
...
**As a** Tenant Admin
**I want** to update a user’s role or status
...
## 🔁 Event Processing (System Stories)
...
## 🧠 Advanced / Senior-Level Stories (Optional)
